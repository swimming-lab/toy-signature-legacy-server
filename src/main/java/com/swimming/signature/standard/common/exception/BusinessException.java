...
public class BusinessException extends RuntimeException {
    ...
    public static final BusinessException FAIL_NOT_PERMISSION = new BusinessException(ExceptionCode.FAIL_NOT_PERMISSION);
    public static final BusinessException FAIL_EXIST_MEMBER = new BusinessException(ExceptionCode.FAIL_EXIST_MEMBER);
    ...
    public static final BusinessException FAIL_NOT_EXIST_MEMBER = new BusinessException(ExceptionCode.FAIL_NOT_EXIST_MEMBER);
    public static final BusinessException FAIL_INVALID_MEMBER_PWD = new BusinessException(ExceptionCode.FAIL_INVALID_MEMBER_PWD);
    ...
    public static final BusinessException FAIL_CONTRACT_ALREADY_DONE = new BusinessException(ExceptionCode.FAIL_CONTRACT_ALREADY_DONE);
