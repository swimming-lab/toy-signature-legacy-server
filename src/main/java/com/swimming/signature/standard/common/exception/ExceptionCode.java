...
public enum ExceptionCode {
    ...
    FAIL_NOT_ALLOWED_MEMBER("F004", "비밀번호가 맞지 않습니다.\n 비밀번호가 기억이 안나실 경우 \n 고객센터에 문의하세요."),
    ...
    FAIL_CANNOT_INSERT_NULL("F025", "필수 항목이 모두 입력되지 않았습니다."),
    ...
    FAIL_INVALID_MEMBER_PWD("F031", "비밀번호가 올바르지 않습니다.\n비밀번호가 기억이 안나실 경우 고객센터에 문의하세요."),

    FAIL_EXIST_MEMBER("F032", "이미 가입된 사업자 입니다. "),

    FAIL_CONTRACT_ALREADY_DONE("F033", "이미 처리된 계약서 입니다."),

    FAIL_NOT_EXIST_MEMBER("F034", "회원이 존재하지 않습니다."),

    FAIL_NOT_PERMISSION("F035", "권한이 없습니다."),
